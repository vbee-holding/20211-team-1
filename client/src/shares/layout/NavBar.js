...
export default function Navbar({action}) {
    return (
        <ul className=" justify-between bg-gray-900 text-white text-base font-text font-medium flex">
            <li className="hover:bg-red-500 px-2 py-3 block sm:hidden cursor-pointer" onClick={action}>
                <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M4 6h16M4 12h16M4 18h16" />
                </svg>
            </li>
            <li className="hover:bg-red-500 px-2 py-3 hidden sm:block">
                <Link to="/" >
                    <span className="hover:border-b-2 border-white ">Trang chủ</span>
                </Link>
            </li>
            <li className="hover:bg-red-500 px-3 py-3 hidden sm:block">
            ...
            <li className="hover:bg-red-500 px-2 py-3 hidden md:block">
            ...
            <li className="border-l-2 border-white hidden sm:block">
                <div className="flex items-center">
                    <input type="text" className="bg-inherit font-text pl-5 pr-3 py-3 hidden lg:block" placeholder="Tìm kiếm thông tin" />
