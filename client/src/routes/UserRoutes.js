...
export const routes = [
  {
    ...
    children: [
      { index: true, element: <Home /> },
      {
        path: "/category",
        children: [
          { path: FE_CATEGORY_CONSTANT_ROUTES.top.path, element: <Category id={FE_CATEGORY_CONSTANT_ROUTES.top.id} /> },
          ...
          { path: FE_CATEGORY_CONSTANT_ROUTES.video.path, element: <Category id={FE_CATEGORY_CONSTANT_ROUTES.video.id} /> },
